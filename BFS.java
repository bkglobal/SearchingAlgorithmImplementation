...
public class BFS {
    ...
    public void SearchTree(Node root, String goalSate) {
        this.root = root;
        this.goalSate = goalSate;
    }
    ...
    public void breadthFirstSearch() {
        ...
        while (!currentNode.getState().equals(goalSate)) {
            ...
            List<String> nodeSuccessors = NodeUtil.getNextNodes(currentNode.getState());
        ...
        NodeUtil.display(currentNode, stateSets, root, time);
...
//**********************************************************************************************
    ...
    public void iterativeDeepening(int depthLimit) {
        ...
        for (int maxDepth = 1; maxDepth < depthLimit; maxDepth++) {
            ...
            while (!mainQueue.isEmpty()) {
                ...
                if (currentNode.getDepth() < maxDepth) {
                    nodeSuccessors = NodeUtil.getNextNodes(currentNode.getState());
                    for (String n : nodeSuccessors) {
                        if (stateSets.contains(n))
                            continue;
        ...
        if (!solutionFound)
            ...
            NodeUtil.display(currentNode, totalVisitedStates, root, time);
